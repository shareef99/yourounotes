    ...
    <section>
      ...
      <div className="my-14 py-14 bg-cardBg">
        ...
        >
          ...
          {Boolean(currentUser) ? (
            <Link href="/admin/[faculty]" as={`/admin/${currentUser.email}`}>
              <a>
                <OutlineButton
                  isDisable={false}
                  label="Dashboard"
        ...
        <div className="colCenter md:flex-row md:items-baseline md:justify-around xl:justify-between flex-wrap">
          <div className="colCenter sm:max-w-xs">
            ...
            <div className="">
              ...
              <p className="font-light text-base text-para">
                we provide the notes, syllabus, previous year question papers,
                Important questions for the students of Bachelor of
                Engineering(BE).
              </p>
            </div>
          </div>
          <div className="colCenter my-14 md:mx-4 sm:max-w-xs">
            ...
            <div className="">
              ...
              <p className="font-light text-base text-para">
                We are students, we collect our resources from our fellow
                students and some great teachers help us with resources and we
                put all of them under one roof for better accessibility.
              </p>
            </div>
          </div>
          <div className="colCenter  sm:max-w-xs">
            ...
            <div className="">
              ...
              <p className="font-light text-base text-para">
                You can help us by providing the resources you have and if you
                find any notes are missing or miss leading you can report us.
